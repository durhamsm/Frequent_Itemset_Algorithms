...
//extended bakery 75k trans, 10 items data set
//dataset_params_t dataset_params = {75000, 10, 10, "./data/75000-out2-10-items.csv"};
//char* column_headers[] = {"Item 1",	"Item 2",	"Item 3",	"Item 4",	"Item 5",	"Item 6",	"Item 7",	"Item 8",	"Item 9",	"Item 10",	"Item 11",	"Item 12",	"Item 13",	"Item 14",	"Item 15",	"Item 16",	"Item 17",	"Item 18",	"Item 19",	"Item 20",	"Item 21",	"Item 22",	"Item 23",	"Item 24",	"Item 25",	"Item 26",	"Item 27",	"Item 28",	"Item 29",	"Item 30",	"Item 31",	"Item 32",	"Item 33",	"Item 34",	"Item 35",	"Item 36",	"Item 37",	"Item 38",	"Item 39",	"Item 40",	"Item 41",	"Item 42",	"Item 43",	"Item 44",	"Item 45",	"Item 46",	"Item 47",	"Item 48",	"Item 49",	"Item 50"};
...
//artifical data set
//In this struct, the first value species num transactions and the second value specifies number of items.
dataset_params_t dataset_params = {10000, 20, 20, ""};
char* column_headers[] = {""};
//here you can change the min support value.
int MIN_SUP = 100;


//simple marketbasket data set
//dataset_params_t dataset_params = {5, 6, 6, "./data/simple_market_basket.csv"};
//char* column_headers[] = {"A", "B", "C", "D", "E", "F"};
//int MIN_SUP = 2;
...
int main(void) {
	...
	//uncomment/comment these lines in order to run FP-Growth (first line) or Apriori (second line).
	fp_analysis();
